...
public class ReactiveRedisOperationsSessionRepository implements
	...
	final class RedisSession implements Session {
        ...
        // WIP: Amit:
//        Flux<Map.Entry<Object, Object>> entries = ReactiveRedisOperationsSessionRepository.this.sessionRedisOperations.opsForHash().entries(originalSessionKey);
//        entries.and((s) -> ReactiveRedisOperationsSessionRepository.this.sessionRedisOperations
//            .opsForHash().putAll(sessionKey, s));
			}
		}
